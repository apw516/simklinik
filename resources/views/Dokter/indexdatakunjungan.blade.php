                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tglawal" value="{{ $date }}"
                                aria-describedby="emailHelp" placeholder="Masukan NIK Pasien ...">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Tanggal Akhir</label>
                            <input type="date" class="form-control" id="tglakhir" value="{{ $date }}"
                                aria-describedby="emailHelp" placeholder="Masukan Nomor RM Pasien ...">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
